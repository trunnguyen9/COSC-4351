...
<asp:Content ID="testimonialContent2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <fieldset>
            ...
            <div class="editor-field">
                <form method="get" action="<%: Url.Action("Testimonials", "Home") %>">
    ...
    %>  
        <% using (Html.BeginForm("PostTestimonial", "Home")) {%>        
        <fieldset class = "postTestimonial">
            <legend>Post Testimonial</legend>        
        <div class="editor-field">
            <%: Html.TextArea("testimonialContent")%>            
        </div>
        <p>
